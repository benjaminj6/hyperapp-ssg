...
test('should return one class name per rule', testDefaultRule, t =>
  t.is(t.context.ruleArray.length, 2)
)

test('document should contain class names in the rule', testDefaultRule, t => {
